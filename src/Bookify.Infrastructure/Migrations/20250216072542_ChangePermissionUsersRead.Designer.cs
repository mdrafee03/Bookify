...
namespace Bookify.Infrastructure.Migrations
{
    ...
    [Migration("20250216072542_ChangePermissionUsersRead")]
    partial class ChangePermissionUsersRead
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PermissionUser", b =>
                {
                    ...
                    b.HasKey("PermissionsId", "UsersId")
                        .HasName("pk_permission_user");

                    b.HasIndex("UsersId")
                        .HasDatabaseName("ix_permission_user_users_id");
            ...
            modelBuilder.Entity("PermissionUser", b =>
                {
                    ...
                    b.HasOne("Bookify.Domain.Users.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_permission_user_users_users_id");
                });
            ...
            modelBuilder.Entity("RoleUser", b =>
                {
                    b.HasOne("Bookify.Domain.Users.Role", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_role_user_roles_user_roles_id");
